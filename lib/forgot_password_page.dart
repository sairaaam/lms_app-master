...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Future<void> _handleResetRequest() async {
    ...
    if (mounted) {
      ...
      if (!success) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text("Error sending reset link. Please try again.")),
        );
      }
    }
  }
  ...
  Widget _buildFormUI() {
    return Column(
      ...
      children: [
        ...
        const Text("We will send a reset link to your email.", textAlign: TextAlign.center),
  ...
  Widget _buildSuccessUI() {
    return Column(
      ...
      children: [
        ...
        Text("A reset link has been sent to ${_emailController.text}.", textAlign: TextAlign.center),
        const SizedBox(height: 32),
        TextButton(
          onPressed: () => Navigator.pop(context),
